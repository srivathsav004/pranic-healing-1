        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 space-y-6" id="founder-biography">
            ...
            <div className="space-y-4 text-slate-600 font-light text-sm md:text-base leading-relaxed">
              <p>
                As an astute chemical engineer, successful businessman, and revered spiritual teacher,{' '}
                <span className="font-semibold text-slate-800">Grand Master Choa Kok Sui</span> spent more than
                three decades research testing the exact physics of energy healing alongside renowned medical
                doctors and alternative masters.
              </p>
              <p>
                His distinct scientific mindset allowed him to strip energy modalities of empty mysticism and
                complex dogma. What remained is <span className="italic font-serif">Pranic Healing</span>—a
                highly direct, non-touch mechanical framework consisting of clear instructions that anyone can
                follow to attain repeatable outcomes.
              </p>
              <p>
                He authored over 20 revolutionary textbooks translated into 40+ languages and established charity
                groups alongside the Institute for Inner Studies globally, ensuring energetic techniques are
                taught on the highest level of moral integrity.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-ivory border-l-4 border-l-gold space-y-2">
              <p className="text-sm font-serif italic text-slate-700 leading-relaxed">
                &ldquo;Pranic Healing is not intended to replace orthodox medicine, but rather to complement
                it. If the ailments are severe or persist, please consult a medical doctor immediately.&rdquo;
              </p>
          ...
          {/* Founder Frame Presentation (Elegant typography placeholder) */}
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-[360px] aspect-[4/5] rounded-3xl overflow-hidden glassmorphism p-6 border border-primary-indigo/10 shadow-2xl flex flex-col justify-between">
              ...
              {/* Upper Frame design details */}
              <div className="flex justify-between items-start">
                <span className="text-[10px] font-mono tracking-widest text-slate-400">MCKS LEGACY PLATFORM</span>
                <BookOpen className="w-5 h-5 text-gold" />
              </div>

              {/* Elegant centered portrait graphic with initials and symbolic rings */}
              <div className="my-auto py-8 text-center space-y-6">
                <div className="relative w-28 h-28 mx-auto rounded-full bg-gradient-to-tr from-primary-indigo via-[#5B21B6] to-gold p-[2px] flex items-center justify-center shadow-lg">
                  <div className="w-full h-full bg-slate-900 rounded-full flex items-center justify-center">
                    <span className="text-3xl font-serif font-bold text-gold">MCKS</span>
                  </div>
                  <span
                    className="absolute -inset-2 rounded-full border border-gold/25 animate-ping"
                    style={{ animationDuration: '4s' }}
                  />
                </div>

                <div className="space-y-1">
                  <h3 className="font-serif text-xl font-light text-slate-800">Master Choa</h3>
                ...
                <p className="text-xs text-slate-600 font-light max-w-xs mx-auto italic">
                  &ldquo;His books remain the world gold standard in non-touch clinical energy
                  therapeutics.&rdquo;
                </p>
              </div>
